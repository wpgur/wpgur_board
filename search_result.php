...
?>
    ...
    <a Onclick="location.href='./index.php'" style="font-size:25px; text-align:center; cursor:pointer;"><b><p>게시판</p></b></a>
    <p style="font-size:15px; text-align:center"><?php echo $catagory; ?> 에서 '<?php echo $search_con; ?>'검색결과</p>
        ...
        <tbody>
            <?php
            $query = "select * from board where $catagory like CONCAT('%','$search_con','%') order by number desc";
